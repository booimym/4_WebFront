...
document.getElementById("check2").addEventListener("click",function(){
    ...
    const regEx3 = /^[abcd]/;
    div1.innerHTML += "/^[abcd]/ , group : " + regEx3.test("group") + "<hr>";   //false
    div1.innerHTML += "/^[abcd]/ , car : " + regEx3.test("car") + "<hr>";       //true
    div1.innerHTML += "/^[abcd]/ , dark : " + regEx3.test("dart") + "<hr>";     //true

    // $(달러) : 문자열의 끝을 의미
    const regEx4 = /team$/;
    div1.innerHTML += "/team$/, A-team : " + regEx4.test("A-team")+ "<hr>"; //true
    div1.innerHTML += "/team$/, team-A : " + regEx4.test("team-A")+ "<hr>"; //false
