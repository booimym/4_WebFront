...
//console.log("함수 종료 후 num5 : " + num5); //num5 is not defined
console.log("함수 종료 후 num6 : " + num6);
...
function typeTest(){
    ...
    //블록 범위 변수 'temp1'를 다시 선언할 수 없습니다.....
    ...
    if(temp1 == 100){
        ...
        let temp2 = 200;
        const temp3 = 300;
        //temp3 = 400; //상수형 변수에 값을 할당해서 error남
    }

    console.log(temp1);
    //console.log(temp2); // temp2 is not defined
    //console.log(temp3); // temp3 is not defined

    ///자료형 확인

    const typeBox = document.getElementById("typeBox");

    typeBox.innerHTML = ""; // typeBox 요소 내부의 내용을 
                            //빈 문자열로 바꾸라는 뜻
                            //(==내부 내용 삭제)

    let name = ""; //undefined에서 string으로 바뀜.....
    //const name2; //error : 상수는 선언과 동시에 초기화가 필수임...

    //typeof 변수명 : 해당 변수의 자료형을 반환하는 연산자
    typeBox.innerHTML += "name :" + name + " / " + typeof name ;
    
    name = "홍길동"; //undefined에서 string으로 바뀜.....
    //const name2; //error : 상수는 선언과 동시에 초기화가 필수임...
    ...
    typeBox.innerHTML +="<br><br>user :" + user + " / " + typeof user; // 걍 object Object라고 나옴
    console.log(user);
    ...
    //함수명만 작성하는 경우 -> 함수에 작성된 <<코드 자체>>가 반환이 된다.....!

    // 함수명(매개변수) == 함수 호출(함수코드가 수행됨..!)
